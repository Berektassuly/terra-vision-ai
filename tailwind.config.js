    ...
    extend: {
      ...
      keyframes: {
        ...
        "slide-in-from-left-1/2": {
          from: { transform: "translateX(calc(-50% - var(--tw-translate-x)))" },
          to: { transform: "translateX(-50%)" },
        },
        "slide-in-from-top-[48%]": {
          from: { transform: "translateY(calc(-48% - var(--tw-translate-y)))" },
          to: { transform: "translateY(-50%)" },
        },
        "slide-out-to-left-1/2": {
          from: { transform: "translateX(-50%)" },
          to: { transform: "translateX(calc(-50% - var(--tw-translate-x)))" },
        },
        "slide-out-to-top-[48%]": {
          from: { transform: "translateY(-50%)" },
          to: { transform: "translateY(calc(-48% - var(--tw-translate-y)))" },
        },
      },
      animation: {
